  ...
  return (
    <div className='my-4 md:p-[0.5px] rounded-sm bg-gradient-to-tr dark:from-slate-600 dark:to-teal-600'>
      <Helmet>
        ...
        <meta name="description" content="Shahed Ahmed's portfolio as a MERN stack developer specializing in front-end development with React.js and Tailwind CSS." />
